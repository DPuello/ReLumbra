...
.on("mousemove", ".card", function(event) {
  ...
  var degX  = ((mouseY / halfHeight) * 15 - 45) + 'deg'; //max degree = 15
...
;(function ($) {
  ...
  $.fn.waterwheelCarousel.defaults = {
    ...
    animationEasing:            '', // the easing effect to use when animating
    ...
    forcedImageWidth:           150,     // specify width of all images; otherwise the carousel tries to calculate it
    forcedImageHeight:          150,     // specify height of all images; otherwise the carousel tries to calculate it
